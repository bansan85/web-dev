...
LLVM_YAML_IS_SEQUENCE_VECTOR(clang_v13::IncludeStyle::IncludeCategory)

namespace llvm {
namespace yaml {

template <>
struct MappingTraits<clang_v13::IncludeStyle::IncludeCategory> {
  static void mapping(IO &IO,
                      clang_v13::IncludeStyle::IncludeCategory &Category);
};

template <>
struct ScalarEnumerationTraits<
    clang_v13::IncludeStyle::IncludeBlocksStyle> {
  static void
  enumeration(IO &IO, clang_v13::IncludeStyle::IncludeBlocksStyle &Value);
};
