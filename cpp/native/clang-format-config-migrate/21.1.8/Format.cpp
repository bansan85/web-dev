  ...
  static void mapping(IO &IO, FormatStyle &Style) {
    ...
    if (IO.outputting()) {
      ...
      if (out.getDefaultStyle()) {
        for (const std::string &StyleName : clang_v21::getStyleNames()) {
          FormatStyle PredefinedStyle;
          if (clang_v21::getPredefinedStyle(StyleName, Style.Language,
                                            &PredefinedStyle) &&
...
FormatStyle getLLVMStyle(FormatStyle::LanguageKind Language) {
  ...
  LLVMStyle.IncludeStyle.IncludeBlocks = clang_v21::IncludeStyle::IBS_Preserve;
  LLVMStyle.IncludeStyle.IncludeCategories = {
      {"^\"(llvm|llvm-c|clang|clang-c)/", 2, 0, false},
      {"^(<|\"(gtest|gmock|isl|json)/)", 3, 0, false},
      {".*", 1, 0, false}};
  LLVMStyle.IncludeStyle.IncludeIsMainRegex = "(Test)?$";
  LLVMStyle.IncludeStyle.MainIncludeChar = clang_v21::IncludeStyle::MICD_Quote;
...
FormatStyle getGoogleStyle(FormatStyle::LanguageKind Language) {
  ...
  GoogleStyle.IncludeStyle.IncludeBlocks = clang_v21::IncludeStyle::IBS_Regroup;
  ...
  if (Language == FormatStyle::LK_Java) {
    ...
    GoogleStyle.IncludeStyle.IncludeBlocks =
        clang_v21::IncludeStyle::IBS_Preserve;
