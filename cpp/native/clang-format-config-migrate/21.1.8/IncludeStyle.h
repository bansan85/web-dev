...
LLVM_YAML_IS_SEQUENCE_VECTOR(clang_v21::IncludeStyle::IncludeCategory)

namespace llvm {
namespace yaml {

template <> struct MappingTraits<clang_v21::IncludeStyle::IncludeCategory> {
  static void mapping(IO &IO,
                      clang_v21::IncludeStyle::IncludeCategory &Category);
};

template <>
struct ScalarEnumerationTraits<clang_v21::IncludeStyle::IncludeBlocksStyle> {
  static void enumeration(IO &IO,
                          clang_v21::IncludeStyle::IncludeBlocksStyle &Value);
};

template <>
struct ScalarEnumerationTraits<
    clang_v21::IncludeStyle::MainIncludeCharDiscriminator> {
  static void
  enumeration(IO &IO,
              clang_v21::IncludeStyle::MainIncludeCharDiscriminator &Value);
};
