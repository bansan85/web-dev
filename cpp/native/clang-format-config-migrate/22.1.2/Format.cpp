...
template <> struct MappingTraits<FormatStyle::AlignConsecutiveStyle> {
  ...
  static void mapping(IO &IO, FormatStyle::AlignConsecutiveStyle &Value) {
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "AlignCompound",
                                         Value.AlignCompound);
    clang_vx::IoMapOptional<FormatStyle>(IO, "AlignFunctionDeclarations",
                                         Value.AlignFunctionDeclarations);
    clang_vx::IoMapOptional<FormatStyle>(IO, "AlignFunctionPointers",
...
struct MappingTraits<FormatStyle::ShortCaseStatementsAlignmentStyle> {
  static void mapping(IO &IO,
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "AcrossComments",
                                         Value.AcrossComments);
    clang_vx::IoMapOptional<FormatStyle>(IO, "AlignCaseArrows",
                                         Value.AlignCaseArrows);
    clang_vx::IoMapOptional<FormatStyle>(IO, "AlignCaseColons",
...
template <> struct MappingTraits<FormatStyle::IntegerLiteralSeparatorStyle> {
  static void mapping(IO &IO, FormatStyle::IntegerLiteralSeparatorStyle &Base) {
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "BinaryMinDigitsInsert",
                                         Base.BinaryMinDigitsInsert);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BinaryMaxDigitsRemove",
                                         Base.BinaryMaxDigitsRemove);
    clang_vx::IoMapOptional<FormatStyle>(IO, "Decimal", Base.Decimal);
    clang_vx::IoMapOptional<FormatStyle>(IO, "DecimalMinDigitsInsert",
                                         Base.DecimalMinDigitsInsert);
    clang_vx::IoMapOptional<FormatStyle>(IO, "DecimalMaxDigitsRemove",
                                         Base.DecimalMaxDigitsRemove);
    clang_vx::IoMapOptional<FormatStyle>(IO, "Hex", Base.Hex);
    clang_vx::IoMapOptional<FormatStyle>(IO, "HexMinDigitsInsert",
                                         Base.HexMinDigitsInsert);
    clang_vx::IoMapOptional<FormatStyle>(IO, "HexMaxDigitsRemove",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "DecimalMinDigits",
                                         Base.DecimalMinDigitsInsert);
    clang_vx::IoMapOptional<FormatStyle>(IO, "HexMinDigits",
                                         Base.HexMinDigitsInsert);
  }
};
...
template <> struct MappingTraits<FormatStyle::KeepEmptyLinesStyle> {
  static void mapping(IO &IO, FormatStyle::KeepEmptyLinesStyle &Value) {
    clang_vx::IoMapOptional<FormatStyle>(IO, "AtEndOfFile", Value.AtEndOfFile);
    clang_vx::IoMapOptional<FormatStyle>(IO, "AtStartOfBlock",
                                         Value.AtStartOfBlock);
    clang_vx::IoMapOptional<FormatStyle>(IO, "AtStartOfFile",
                                         Value.AtStartOfFile);
  }
};
...
template <> struct MappingTraits<FormatStyle::NumericLiteralCaseStyle> {
  static void mapping(IO &IO, FormatStyle::NumericLiteralCaseStyle &Value) {
    clang_vx::IoMapOptional<FormatStyle>(IO, "ExponentLetter",
                                         Value.ExponentLetter);
    clang_vx::IoMapOptional<FormatStyle>(IO, "HexDigit", Value.HexDigit);
    clang_vx::IoMapOptional<FormatStyle>(IO, "Prefix", Value.Prefix);
    clang_vx::IoMapOptional<FormatStyle>(IO, "Suffix", Value.Suffix);
  }
};
...
template <> struct MappingTraits<FormatStyle::SortIncludesOptions> {
  ...
  static void mapping(IO &IO, FormatStyle::SortIncludesOptions &Value) {
    clang_vx::IoMapOptional<FormatStyle>(IO, "Enabled", Value.Enabled);
    clang_vx::IoMapOptional<FormatStyle>(IO, "IgnoreCase", Value.IgnoreCase);
    clang_vx::IoMapOptional<FormatStyle>(IO, "IgnoreExtension",
...
template <> struct MappingTraits<FormatStyle::SpaceBeforeParensCustom> {
  static void mapping(IO &IO, FormatStyle::SpaceBeforeParensCustom &Spacing) {
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "AfterNot", Spacing.AfterNot);
    clang_vx::IoMapOptional<FormatStyle>(IO, "AfterOverloadedOperator",
                                         Spacing.AfterOverloadedOperator);
    clang_vx::IoMapOptional<FormatStyle>(IO, "AfterPlacementOperator",
                                         Spacing.AfterPlacementOperator);
...
template <> struct MappingTraits<FormatStyle::SpacesInParensCustom> {
  static void mapping(IO &IO, FormatStyle::SpacesInParensCustom &Spaces) {
    clang_vx::IoMapOptional<FormatStyle>(IO, "ExceptDoubleParentheses",
                                         Spaces.ExceptDoubleParentheses);
    clang_vx::IoMapOptional<FormatStyle>(IO, "InCStyleCasts",
                                         Spaces.InCStyleCasts);
    clang_vx::IoMapOptional<FormatStyle>(IO, "InConditionalStatements",
                                         Spaces.InConditionalStatements);
    clang_vx::IoMapOptional<FormatStyle>(IO, "InEmptyParentheses",
                                         Spaces.InEmptyParentheses);
    clang_vx::IoMapOptional<FormatStyle>(IO, "Other", Spaces.Other);
  }
};
...
template <> struct MappingTraits<FormatStyle::TrailingCommentsAlignmentStyle> {
  ...
  static void mapping(IO &IO,
                      FormatStyle::TrailingCommentsAlignmentStyle &Value) {
    clang_vx::IoMapOptional<FormatStyle>(IO, "AlignPPAndNotPP",
  ...
  static void mapping(IO &IO, FormatStyle &Style) {
    ...
    if (IO.outputting()) {
      ...
      if (out.getDefaultStyle()) {
        for (const std::string &StyleName : clang_v22::getStyleNames()) {
          FormatStyle PredefinedStyle;
          if (clang_v22::getPredefinedStyle(StyleName, Style.Language,
                                            &PredefinedStyle) &&
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "AllowBreakBeforeQtProperty",
    ...
    clang_vx::IoMapOptional<FormatStyle>(
        IO, "AllowShortNamespacesOnASingleLine",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "BinPackLongBracedList",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "BracedInitializerIndentWidth",
                                         Style.BracedInitializerIndentWidth);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BraceWrapping",
                                         Style.BraceWrapping);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakAdjacentStringLiterals",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakAfterOpenBracketBracedList",
                                         Style.BreakAfterOpenBracketBracedList);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakAfterOpenBracketFunction",
                                         Style.BreakAfterOpenBracketFunction);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakAfterOpenBracketIf",
                                         Style.BreakAfterOpenBracketIf);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakAfterOpenBracketLoop",
                                         Style.BreakAfterOpenBracketLoop);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakAfterOpenBracketSwitch",
                                         Style.BreakAfterOpenBracketSwitch);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakAfterReturnType",
    ...
    clang_vx::IoMapOptional<FormatStyle>(
        IO, "BreakBeforeCloseBracketBracedList",
        Style.BreakBeforeCloseBracketBracedList);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakBeforeCloseBracketFunction",
                                         Style.BreakBeforeCloseBracketFunction);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakBeforeCloseBracketIf",
                                         Style.BreakBeforeCloseBracketIf);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakBeforeCloseBracketLoop",
                                         Style.BreakBeforeCloseBracketLoop);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakBeforeCloseBracketSwitch",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakBeforeTemplateCloser",
                                         Style.BreakBeforeTemplateCloser);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakBeforeTernaryOperators",
                                         Style.BreakBeforeTernaryOperators);
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakBinaryOperations",
                                         Style.BreakBinaryOperations);
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "BreakTemplateDeclarations",
                                         Style.BreakTemplateDeclarations);
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "EnumTrailingComma",
                                         Style.EnumTrailingComma);
    clang_vx::IoMapOptional<FormatStyle>(
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "IndentExportBlock",
                                         Style.IndentExportBlock);
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "KeepEmptyLines",
                                         Style.KeepEmptyLines);
    clang_vx::IoMapOptional<FormatStyle>(IO, "KeepFormFeed",
                                         Style.KeepFormFeed);
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "MacroBlockEnd",
                                         Style.MacroBlockEnd);
    clang_vx::IoMapOptional<FormatStyle>(IO, "Macros", Style.Macros);
    clang_vx::IoMapOptional<FormatStyle>(
        IO, "MacrosSkippedByRemoveParentheses",
        Style.MacrosSkippedByRemoveParentheses);
    clang_vx::IoMapOptional<FormatStyle>(IO, "MainIncludeChar",
                                         Style.IncludeStyle.MainIncludeChar);
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "NumericLiteralCase",
                                         Style.NumericLiteralCase);
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "ObjCPropertyAttributeOrder",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "OneLineFormatOffRegex",
                                         Style.OneLineFormatOffRegex);
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "PenaltyBreakBeforeMemberAccess",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "PenaltyBreakScopeResolution",
    ...
    clang_vx::IoMapOptional<FormatStyle>(
        IO, "RemoveEmptyLinesInUnwrappedLines",
        Style.RemoveEmptyLinesInUnwrappedLines);
    clang_vx::IoMapOptional<FormatStyle>(IO, "RemoveParentheses",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "SkipMacroDefinitionBody",
                                         Style.SkipMacroDefinitionBody);
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "SpaceAfterOperatorKeyword",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "SpaceBeforeJsonColon",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "SpaceInEmptyBraces",
                                         Style.SpaceInEmptyBraces);
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "SpacesInParens",
                                         Style.SpacesInParens);
    clang_vx::IoMapOptional<FormatStyle>(IO, "SpacesInParensOptions",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "TableGenBreakingDAGArgOperators",
                                         Style.TableGenBreakingDAGArgOperators);
    clang_vx::IoMapOptional<FormatStyle>(IO, "TableGenBreakInsideDAGArg",
                                         Style.TableGenBreakInsideDAGArg);
    clang_vx::IoMapOptional<FormatStyle>(IO, "TabWidth", Style.TabWidth);
    clang_vx::IoMapOptional<FormatStyle>(IO, "TemplateNames",
                                         Style.TemplateNames);
    clang_vx::IoMapOptional<FormatStyle>(IO, "TypeNames", Style.TypeNames);
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "VariableTemplates",
                                         Style.VariableTemplates);
    clang_vx::IoMapOptional<FormatStyle>(
        IO, "VerilogBreakBetweenInstancePorts",
        Style.VerilogBreakBetweenInstancePorts);
    clang_vx::IoMapOptional<FormatStyle>(IO, "WhitespaceSensitiveMacros",
                                         Style.WhitespaceSensitiveMacros);
    clang_vx::IoMapOptional<FormatStyle>(IO, "WrapNamespaceBodyWithEmptyLines",
...
FormatStyle getLLVMStyle(FormatStyle::LanguageKind Language) {
  ...
  LLVMStyle.IncludeStyle.IncludeBlocks = clang_v22::IncludeStyle::IBS_Preserve;
  LLVMStyle.IncludeStyle.IncludeCategories = {
      {"^\"(llvm|llvm-c|clang|clang-c)/", 2, 0, false},
      {"^(<|\"(gtest|gmock|isl|json)/)", 3, 0, false},
      {".*", 1, 0, false}};
  LLVMStyle.IncludeStyle.IncludeIsMainRegex = "(Test)?$";
  LLVMStyle.IncludeStyle.MainIncludeChar = clang_v22::IncludeStyle::MICD_Quote;
...
FormatStyle getGoogleStyle(FormatStyle::LanguageKind Language) {
  ...
  GoogleStyle.IncludeStyle.IncludeBlocks = clang_v22::IncludeStyle::IBS_Regroup;
  ...
  if (Language == FormatStyle::LK_Java) {
    ...
    GoogleStyle.IncludeStyle.IncludeBlocks =
        clang_v22::IncludeStyle::IBS_Preserve;
