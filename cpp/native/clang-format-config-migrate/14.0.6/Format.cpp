...
template <> struct MappingTraits<FormatStyle> {
  static void mapping(IO &IO, FormatStyle &Style) {
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "DeriveLineEnding",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "IndentRequires",
    ...
    clang_vx::IoMapOptional<FormatStyle>(IO, "UseCRLF", Style.UseCRLF);
