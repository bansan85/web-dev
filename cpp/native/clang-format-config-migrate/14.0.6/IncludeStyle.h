...
LLVM_YAML_IS_SEQUENCE_VECTOR(clang_v14::IncludeStyle::IncludeCategory)

namespace llvm {
namespace yaml {

template <>
struct MappingTraits<clang_v14::IncludeStyle::IncludeCategory> {
  static void mapping(IO &IO,
                      clang_v14::IncludeStyle::IncludeCategory &Category);
};

template <>
struct ScalarEnumerationTraits<
    clang_v14::IncludeStyle::IncludeBlocksStyle> {
  static void
  enumeration(IO &IO, clang_v14::IncludeStyle::IncludeBlocksStyle &Value);
};
