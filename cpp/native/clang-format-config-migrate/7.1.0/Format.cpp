...
LLVM_YAML_IS_SEQUENCE_VECTOR(clang_v7::FormatStyle::RawStringFormat)
...
template <> struct MappingTraits<FormatStyle> {
  static void mapping(IO &IO, FormatStyle &Style) {
    ...
    if (IO.outputting()) {
      clang_vx::OutputDiffOnly<clang_v7::FormatStyle> &out =
          static_cast<clang_vx::OutputDiffOnly<clang_v7::FormatStyle> &>(IO);
      if (out.getDefaultStyle()) {
        for (const std::string &StyleName : clang_v7::getStyleNames()) {
          clang_v7::FormatStyle PredefinedStyle;
    ...
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AccessModifierOffset",
                                                   Style.AccessModifierOffset);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AlignAfterOpenBracket",
                                                   Style.AlignAfterOpenBracket);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AlignEscapedNewlines",
                                                   Style.AlignEscapedNewlines);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AlignOperands",
                                                   Style.AlignOperands);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AlignTrailingComments",
    ...
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "BinPackArguments",
                                                   Style.BinPackArguments);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "BinPackParameters",
                                                   Style.BinPackParameters);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "BraceWrapping",
                                                   Style.BraceWrapping);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
        IO, "BreakBeforeBinaryOperators", Style.BreakBeforeBinaryOperators);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "BreakBeforeBraces",
                                                   Style.BreakBeforeBraces);

    bool BreakBeforeInheritanceComma = false;
    clang_vx::IoMapOptionalHardcodedValue<clang_v7::FormatStyle>(
        IO, "BreakBeforeInheritanceComma", BreakBeforeInheritanceComma);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "BreakInheritanceList",
    ...
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "BreakStringLiterals",
                                                   Style.BreakStringLiterals);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "ColumnLimit",
                                                   Style.ColumnLimit);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "CommentPragmas",
                                                   Style.CommentPragmas);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "CompactNamespaces",
    ...
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "Cpp11BracedListStyle",
                                                   Style.Cpp11BracedListStyle);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
        IO, "DerivePointerAlignment", Style.DerivePointerAlignment);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "DisableFormat",
                                                   Style.DisableFormat);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
        IO, "ExperimentalAutoDetectBinPacking",
        Style.ExperimentalAutoDetectBinPacking);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "FixNamespaceComments",
                                                   Style.FixNamespaceComments);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "ForEachMacros",
                                                   Style.ForEachMacros);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "IndentCaseLabels",
                                                   Style.IndentCaseLabels);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "IndentPPDirectives",
                                                   Style.IndentPPDirectives);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "IndentWidth",
                                                   Style.IndentWidth);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
        IO, "IndentWrappedFunctionNames", Style.IndentWrappedFunctionNames);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "JavaScriptQuotes",
                                                   Style.JavaScriptQuotes);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "JavaScriptWrapImports",
                                                   Style.JavaScriptWrapImports);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
        IO, "KeepEmptyLinesAtTheStartOfBlocks",
        Style.KeepEmptyLinesAtTheStartOfBlocks);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "MacroBlockBegin",
                                                   Style.MacroBlockBegin);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "MacroBlockEnd",
                                                   Style.MacroBlockEnd);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "MaxEmptyLinesToKeep",
                                                   Style.MaxEmptyLinesToKeep);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "NamespaceIndentation",
                                                   Style.NamespaceIndentation);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
        IO, "ObjCBinPackProtocolList", Style.ObjCBinPackProtocolList);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "ObjCBlockIndentWidth",
    ...
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "PenaltyBreakComment",
                                                   Style.PenaltyBreakComment);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
        IO, "PenaltyBreakFirstLessLess", Style.PenaltyBreakFirstLessLess);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "PenaltyBreakString",
    ...
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "PointerAlignment",
                                                   Style.PointerAlignment);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "RawStringFormats",
                                                   Style.RawStringFormats);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "ReflowComments",
                                                   Style.ReflowComments);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "SortIncludes",
                                                   Style.SortIncludes);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "SortUsingDeclarations",
                                                   Style.SortUsingDeclarations);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "SpaceAfterCStyleCast",
    ...
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "SpaceBeforeParens",
                                                   Style.SpaceBeforeParens);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "SpacesInAngles",
    ...
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "SpacesInParentheses",
                                                   Style.SpacesInParentheses);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
        IO, "SpacesInSquareBrackets", Style.SpacesInSquareBrackets);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "Standard",
                                                   Style.Standard);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "TabWidth",
                                                   Style.TabWidth);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "UseTab", Style.UseTab);
  }
};

template <> struct MappingTraits<FormatStyle::BraceWrappingFlags> {
  static void mapping(IO &IO, FormatStyle::BraceWrappingFlags &Wrapping) {
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AfterClass",
                                                   Wrapping.AfterClass);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
        IO, "AfterControlStatement", Wrapping.AfterControlStatement);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AfterEnum",
                                                   Wrapping.AfterEnum);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AfterFunction",
                                                   Wrapping.AfterFunction);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AfterNamespace",
                                                   Wrapping.AfterNamespace);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(
        IO, "AfterObjCDeclaration", Wrapping.AfterObjCDeclaration);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AfterStruct",
                                                   Wrapping.AfterStruct);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AfterUnion",
                                                   Wrapping.AfterUnion);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "AfterExternBlock",
                                                   Wrapping.AfterExternBlock);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "BeforeCatch",
                                                   Wrapping.BeforeCatch);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "BeforeElse",
                                                   Wrapping.BeforeElse);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "IndentBraces",
                                                   Wrapping.IndentBraces);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "SplitEmptyFunction",
                                                   Wrapping.SplitEmptyFunction);
    clang_vx::IoMapOptional<clang_v7::FormatStyle>(IO, "SplitEmptyRecord",
