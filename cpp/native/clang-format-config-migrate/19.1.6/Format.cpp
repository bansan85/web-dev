...
template <> struct MappingTraits<FormatStyle::AlignConsecutiveStyle> {
  ...
  static void mapping(IO &IO, FormatStyle::AlignConsecutiveStyle &Value) {
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "Enabled",
                                                    Value.Enabled);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AcrossEmptyLines",
                                                    Value.AcrossEmptyLines);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AcrossComments",
                                                    Value.AcrossComments);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AlignCompound",
                                                    Value.AlignCompound);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "AlignFunctionPointers", Value.AlignFunctionPointers);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "PadOperators",
                                                    Value.PadOperators);
  }
};
...
struct MappingTraits<FormatStyle::ShortCaseStatementsAlignmentStyle> {
  static void mapping(IO &IO,
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AcrossComments",
                                                    Value.AcrossComments);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AlignCaseArrows",
                                                    Value.AlignCaseArrows);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AlignCaseColons",
...
template <> struct MappingTraits<FormatStyle::BraceWrappingFlags> {
  static void mapping(IO &IO, FormatStyle::BraceWrappingFlags &Wrapping) {
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AfterCaseLabel",
                                                    Wrapping.AfterCaseLabel);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AfterClass",
                                                    Wrapping.AfterClass);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "AfterControlStatement", Wrapping.AfterControlStatement);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AfterEnum",
                                                    Wrapping.AfterEnum);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AfterExternBlock",
                                                    Wrapping.AfterExternBlock);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AfterFunction",
                                                    Wrapping.AfterFunction);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AfterNamespace",
                                                    Wrapping.AfterNamespace);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "AfterObjCDeclaration", Wrapping.AfterObjCDeclaration);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AfterStruct",
                                                    Wrapping.AfterStruct);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AfterUnion",
                                                    Wrapping.AfterUnion);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BeforeCatch",
                                                    Wrapping.BeforeCatch);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BeforeElse",
                                                    Wrapping.BeforeElse);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BeforeLambdaBody",
                                                    Wrapping.BeforeLambdaBody);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BeforeWhile",
                                                    Wrapping.BeforeWhile);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "IndentBraces",
                                                    Wrapping.IndentBraces);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "SplitEmptyFunction", Wrapping.SplitEmptyFunction);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "SplitEmptyRecord",
...
template <> struct MappingTraits<FormatStyle::IntegerLiteralSeparatorStyle> {
  static void mapping(IO &IO, FormatStyle::IntegerLiteralSeparatorStyle &Base) {
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "Binary", Base.Binary);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BinaryMinDigits",
                                                    Base.BinaryMinDigits);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "Decimal",
                                                    Base.Decimal);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "DecimalMinDigits",
                                                    Base.DecimalMinDigits);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "Hex", Base.Hex);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "HexMinDigits",
                                                    Base.HexMinDigits);
  }
};
...
template <> struct MappingTraits<FormatStyle::KeepEmptyLinesStyle> {
  static void mapping(IO &IO, FormatStyle::KeepEmptyLinesStyle &Value) {
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AtEndOfFile",
                                                    Value.AtEndOfFile);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AtStartOfBlock",
                                                    Value.AtStartOfBlock);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AtStartOfFile",
                                                    Value.AtStartOfFile);
  }
};
...
template <> struct MappingTraits<FormatStyle::SpaceBeforeParensCustom> {
  static void mapping(IO &IO, FormatStyle::SpaceBeforeParensCustom &Spacing) {
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AfterForeachMacros",
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AfterIfMacros",
                                                    Spacing.AfterIfMacros);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "AfterOverloadedOperator", Spacing.AfterOverloadedOperator);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "AfterPlacementOperator", Spacing.AfterPlacementOperator);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
...
template <> struct MappingTraits<FormatStyle::SpacesInLineComment> {
  static void mapping(IO &IO, FormatStyle::SpacesInLineComment &Space) {
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "Minimum",
                                                    Space.Minimum);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
...
template <> struct MappingTraits<FormatStyle::SpacesInParensCustom> {
  static void mapping(IO &IO, FormatStyle::SpacesInParensCustom &Spaces) {
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "ExceptDoubleParentheses", Spaces.ExceptDoubleParentheses);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "InCStyleCasts",
                                                    Spaces.InCStyleCasts);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "InConditionalStatements", Spaces.InConditionalStatements);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "InEmptyParentheses",
                                                    Spaces.InEmptyParentheses);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "Other", Spaces.Other);
  }
};
...
template <> struct MappingTraits<FormatStyle::TrailingCommentsAlignmentStyle> {
  ...
  static void mapping(IO &IO,
                      FormatStyle::TrailingCommentsAlignmentStyle &Value) {
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "Kind", Value.Kind);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "OverEmptyLines",
...
template <> struct MappingTraits<FormatStyle> {
  static void mapping(IO &IO, FormatStyle &Style) {
    ...
    if (IO.outputting()) {
      clang_vx::OutputDiffOnly<clang_v19::FormatStyle> &out =
          static_cast<clang_vx::OutputDiffOnly<clang_v19::FormatStyle> &>(IO);
      if (out.getDefaultStyle()) {
        for (const std::string &StyleName : clang_v19::getStyleNames()) {
          clang_v19::FormatStyle PredefinedStyle;
          if (clang_v19::getPredefinedStyle(StyleName, Style.Language,
                                            &PredefinedStyle) &&
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AccessModifierOffset",
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "AlignConsecutiveShortCaseStatements",
        Style.AlignConsecutiveShortCaseStatements);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "AlignConsecutiveTableGenBreakingDAGArgColons",
        Style.AlignConsecutiveTableGenBreakingDAGArgColons);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "AlignConsecutiveTableGenCondOperatorColons",
        Style.AlignConsecutiveTableGenCondOperatorColons);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "AlignConsecutiveTableGenDefinitionColons",
        Style.AlignConsecutiveTableGenDefinitionColons);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AlignEscapedNewlines",
                                                    Style.AlignEscapedNewlines);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AlignOperands",
                                                    Style.AlignOperands);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "AttributeMacros",
                                                    Style.AttributeMacros);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BinPackArguments",
                                                    Style.BinPackArguments);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BinPackParameters",
                                                    Style.BinPackParameters);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BitFieldColonSpacing",
                                                    Style.BitFieldColonSpacing);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "BracedInitializerIndentWidth", Style.BracedInitializerIndentWidth);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BraceWrapping",
                                                    Style.BraceWrapping);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "BreakAdjacentStringLiterals", Style.BreakAdjacentStringLiterals);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BreakAfterAttributes",
                                                    Style.BreakAfterAttributes);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "BreakAfterJavaFieldAnnotations",
        Style.BreakAfterJavaFieldAnnotations);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BreakAfterReturnType",
                                                    Style.BreakAfterReturnType);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BreakArrays",
                                                    Style.BreakArrays);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BreakBeforeBraces",
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "BreakFunctionDefinitionParameters",
        Style.BreakFunctionDefinitionParameters);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BreakInheritanceList",
                                                    Style.BreakInheritanceList);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "BreakStringLiterals",
                                                    Style.BreakStringLiterals);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "BreakTemplateDeclarations", Style.BreakTemplateDeclarations);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "ColumnLimit",
                                                    Style.ColumnLimit);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "CommentPragmas",
                                                    Style.CommentPragmas);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "CompactNamespaces",
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "Cpp11BracedListStyle",
                                                    Style.Cpp11BracedListStyle);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "DerivePointerAlignment", Style.DerivePointerAlignment);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "DisableFormat",
                                                    Style.DisableFormat);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "FixNamespaceComments",
                                                    Style.FixNamespaceComments);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "ForEachMacros",
                                                    Style.ForEachMacros);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "IfMacros",
                                                    Style.IfMacros);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "IndentCaseBlocks",
                                                    Style.IndentCaseBlocks);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "IndentCaseLabels",
                                                    Style.IndentCaseLabels);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "IndentExternBlock",
                                                    Style.IndentExternBlock);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "IndentGotoLabels",
                                                    Style.IndentGotoLabels);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "IndentPPDirectives",
                                                    Style.IndentPPDirectives);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "IndentRequiresClause",
                                                    Style.IndentRequiresClause);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "IndentWidth",
                                                    Style.IndentWidth);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "IndentWrappedFunctionNames", Style.IndentWrappedFunctionNames);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "InsertBraces",
                                                    Style.InsertBraces);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "InsertNewlineAtEOF",
                                                    Style.InsertNewlineAtEOF);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "InsertTrailingCommas",
                                                    Style.InsertTrailingCommas);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "IntegerLiteralSeparator", Style.IntegerLiteralSeparator);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "JavaImportGroups",
                                                    Style.JavaImportGroups);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "JavaScriptQuotes",
                                                    Style.JavaScriptQuotes);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "JavaScriptWrapImports", Style.JavaScriptWrapImports);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "KeepEmptyLines",
                                                    Style.KeepEmptyLines);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "LambdaBodyIndentation", Style.LambdaBodyIndentation);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "LineEnding",
                                                    Style.LineEnding);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "MacroBlockBegin",
                                                    Style.MacroBlockBegin);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "MacroBlockEnd",
                                                    Style.MacroBlockEnd);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "Macros", Style.Macros);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "MainIncludeChar", Style.IncludeStyle.MainIncludeChar);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "MaxEmptyLinesToKeep",
                                                    Style.MaxEmptyLinesToKeep);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "NamespaceIndentation",
                                                    Style.NamespaceIndentation);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "NamespaceMacros",
                                                    Style.NamespaceMacros);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "ObjCBinPackProtocolList", Style.ObjCBinPackProtocolList);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "ObjCBlockIndentWidth",
                                                    Style.ObjCBlockIndentWidth);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "ObjCBreakBeforeNestedBlockParam",
        Style.ObjCBreakBeforeNestedBlockParam);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "ObjCPropertyAttributeOrder", Style.ObjCPropertyAttributeOrder);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "PenaltyBreakComment",
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "PenaltyBreakScopeResolution", Style.PenaltyBreakScopeResolution);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "PenaltyBreakString",
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "PointerAlignment",
                                                    Style.PointerAlignment);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "PPIndentWidth",
                                                    Style.PPIndentWidth);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "QualifierAlignment",
    ...
    if (Style.QualifierAlignment == FormatStyle::QAS_Right)
      ...
      clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "QualifierOrder",
                                                      Style.QualifierOrder);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "RawStringFormats",
                                                    Style.RawStringFormats);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "ReferenceAlignment",
                                                    Style.ReferenceAlignment);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "ReflowComments",
                                                    Style.ReflowComments);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "RemoveBracesLLVM",
                                                    Style.RemoveBracesLLVM);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "RemoveParentheses",
                                                    Style.RemoveParentheses);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "RemoveSemicolon",
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "ShortNamespaceLines",
                                                    Style.ShortNamespaceLines);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "SkipMacroDefinitionBody", Style.SkipMacroDefinitionBody);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "SortIncludes",
                                                    Style.SortIncludes);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "SortJavaStaticImport",
                                                    Style.SortJavaStaticImport);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "SortUsingDeclarations", Style.SortUsingDeclarations);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "SpaceAfterCStyleCast",
                                                    Style.SpaceAfterCStyleCast);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "SpaceAfterLogicalNot",
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "SpaceBeforeCaseColon",
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "SpaceBeforeJsonColon",
                                                    Style.SpaceBeforeJsonColon);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "SpaceBeforeParens",
                                                    Style.SpaceBeforeParens);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "SpaceInEmptyBlock",
                                                    Style.SpaceInEmptyBlock);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "SpacesBeforeTrailingComments", Style.SpacesBeforeTrailingComments);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "SpacesInAngles",
    ...
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "SpacesInParens",
                                                    Style.SpacesInParens);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "SpacesInParensOptions", Style.SpacesInParensOptions);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "SpacesInSquareBrackets", Style.SpacesInSquareBrackets);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "Standard",
                                                    Style.Standard);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "StatementAttributeLikeMacros", Style.StatementAttributeLikeMacros);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "StatementMacros",
                                                    Style.StatementMacros);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "TableGenBreakingDAGArgOperators",
        Style.TableGenBreakingDAGArgOperators);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "TableGenBreakInsideDAGArg", Style.TableGenBreakInsideDAGArg);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "TabWidth",
                                                    Style.TabWidth);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "TypeNames",
                                                    Style.TypeNames);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "TypenameMacros",
                                                    Style.TypenameMacros);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(IO, "UseTab", Style.UseTab);
    clang_vx::IoMapOptional<clang_v19::FormatStyle>(
        IO, "VerilogBreakBetweenInstancePorts",
