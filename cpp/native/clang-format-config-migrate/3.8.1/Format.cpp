...
using clang_v3_8::FormatStyle;

LLVM_YAML_IS_SEQUENCE_VECTOR(clang_v3_8::FormatStyle::IncludeCategory)
...
template <> struct MappingTraits<FormatStyle> {
  static void mapping(IO &IO, FormatStyle &Style) {
    ...
    if (IO.outputting()) {
      clang_vx::OutputDiffOnly<clang_v3_8::FormatStyle> &out =
          static_cast<clang_vx::OutputDiffOnly<clang_v3_8::FormatStyle> &>(IO);
      if (out.getDefaultStyle()) {
        for (const std::string &StyleName : clang_v3_8::getStyleNames()) {
          clang_v3_8::FormatStyle PredefinedStyle;
          if (clang_v3_8::getPredefinedStyle(StyleName, Style.Language,
                                             &PredefinedStyle) &&
    ...
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "AlignOperands",
                                                     Style.AlignOperands);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "BinPackArguments",
                                                     Style.BinPackArguments);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "BinPackParameters",
                                                     Style.BinPackParameters);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "BraceWrapping",
                                                     Style.BraceWrapping);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(
        IO, "BreakBeforeBinaryOperators", Style.BreakBeforeBinaryOperators);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "BreakBeforeBraces",
    ...
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "ColumnLimit",
                                                     Style.ColumnLimit);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "CommentPragmas",
    ...
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "DisableFormat",
                                                     Style.DisableFormat);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(
        IO, "ExperimentalAutoDetectBinPacking",
        Style.ExperimentalAutoDetectBinPacking);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "ForEachMacros",
                                                     Style.ForEachMacros);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "IncludeCategories",
                                                     Style.IncludeCategories);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "IndentCaseLabels",
                                                     Style.IndentCaseLabels);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "IndentWidth",
                                                     Style.IndentWidth);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "MacroBlockBegin",
                                                     Style.MacroBlockBegin);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "MacroBlockEnd",
                                                     Style.MacroBlockEnd);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "MaxEmptyLinesToKeep",
    ...
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "PenaltyBreakComment",
                                                     Style.PenaltyBreakComment);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(
        IO, "PenaltyBreakFirstLessLess", Style.PenaltyBreakFirstLessLess);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "PenaltyBreakString",
    ...
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "PointerAlignment",
                                                     Style.PointerAlignment);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "ReflowComments",
                                                     Style.ReflowComments);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "SortIncludes",
                                                     Style.SortIncludes);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "SpaceBeforeParens",
                                                     Style.SpaceBeforeParens);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(
    ...
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "SpacesInAngles",
    ...
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "SpacesInParentheses",
                                                     Style.SpacesInParentheses);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(
        IO, "SpacesInSquareBrackets", Style.SpacesInSquareBrackets);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "Standard",
                                                     Style.Standard);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "TabWidth",
                                                     Style.TabWidth);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "UseTab",
                                                     Style.UseTab);
  }
};
...
template <> struct MappingTraits<FormatStyle::BraceWrappingFlags> {
  static void mapping(IO &IO, FormatStyle::BraceWrappingFlags &Wrapping) {
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "AfterClass",
                                                     Wrapping.AfterClass);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(
        IO, "AfterControlStatement", Wrapping.AfterControlStatement);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "AfterEnum",
                                                     Wrapping.AfterEnum);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "AfterFunction",
                                                     Wrapping.AfterFunction);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "AfterNamespace",
                                                     Wrapping.AfterNamespace);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(
        IO, "AfterObjCDeclaration", Wrapping.AfterObjCDeclaration);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "AfterStruct",
                                                     Wrapping.AfterStruct);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "AfterUnion",
                                                     Wrapping.AfterUnion);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "BeforeCatch",
                                                     Wrapping.BeforeCatch);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "BeforeElse",
                                                     Wrapping.BeforeElse);
    clang_vx::IoMapOptional<clang_v3_8::FormatStyle>(IO, "IndentBraces",
